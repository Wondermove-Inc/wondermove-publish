    ...
    <div className={styles.vivaUi}>
      ...
      <div className={styles.groupContainer}>
        ...
        <div className={styles.rectangleParent1}>
          ...
          <div className={styles.eastToImplementParent}>
            ...
            <div className={styles.theFrameworkIs}>
              ...
              allowing you to quickly build services by mixing and matching the
              features you want.
            </div>
          </div>
        </div>
        <img className={styles.groupChild3} alt="" src="/viva/group-4364.svg" />
        <div className={styles.vectorGroup}>
          ...
          <img className={styles.frameIcon} alt="" src="/viva/frame-4365.svg" />
        </div>
      </div>
      ...
      <div className={styles.frameDiv}>
        <div className={styles.frameParent1}>
          ...
          <div className={styles.component113}>
            ...
            />
            <img className={styles.iconMore} alt="" src="/viva/icon-more.svg" />
          ...
          <div className={styles.frameParent3}>
            ...
            <div className={styles.theCarHasGoodQualityParent}>
              <div className={styles.theCarHas}>The car has good quality!</div>
        ...
        <div className={styles.layer1Parent}>
          ...
          <div className={styles.wondermoveSpinOffOfHyundaiParent}>
            ...
            <div className={styles.wondermoveIncBusinessContainer}>
              ...
              <p className={styles.reactNative}>
                Address: 2F, 104, Nonhyeon-ro 27-gil, Seocho-gu, Seoul, Republic
                of Korea
              </p>
              <p className={styles.reactNative}>
